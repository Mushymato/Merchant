...
### Fixed
- FurnitureFramework integration should be enabled for FurnitureFramework-3.3.0

## [1.2.4] - 2026-03-15

### Fixed

- Added more null checks, fixed a bad one for auto-restock
...
- Description in theme boosts for how many (new i18n key, `"theme-boost.unaffected"` in gui.json)
